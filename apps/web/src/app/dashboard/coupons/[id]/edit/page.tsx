...
import { useCouponQuery, useUpdateCoupon } from "@/hooks/use-coupons";
...
export default function EditCouponPage() {
	...
	const { data: coupon, isLoading: isCouponLoading } = useCouponQuery(couponId);
		...
		<div className="flex flex-1 flex-col gap-4 p-4 pt-0">
			...
			<Card className="w-full">
				<CardHeader>
					...
					<CardDescription>
						Update the information below to edit the coupon.
					</CardDescription>
				</CardHeader>
				<CardContent>
